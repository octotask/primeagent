"""Script to generate nightly tags for WFX package."""
...
def get_latest_published_version(*, is_nightly: bool) -> Version:
    url = PYPI_WFX_NIGHTLY_URL if is_nightly else PYPI_WFX_URL
...
def create_wfx_tag():
    # Since WFX has never been released, we'll use the version from pyproject.toml as base
    ...
    try:
        ...
        # If WFX nightly doesn't exist on PyPI yet, this is the first nightly
